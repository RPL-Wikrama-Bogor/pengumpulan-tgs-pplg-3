                ...
                <tr>
                  ...
                  <td> 
                    <?php
                        ...
                        if ($selisih_hari != 0 && $selisih_hari != 1) {
                            echo '<a href="' . BASE_URL . '/pinjam/edit/' . $row['id'] . '" class="btn btn-primary">Edit</a>'; // Mengganti ikon dengan teks "Edit"
                        }
                    ?>
                        <a href="<?= BASE_URL ?>/pinjam/hapus/<?= $row['id'] ?>" class="btn btn-danger" onclick="return confirm('Hapus data?');">Hapus</a> <!-- Mengganti ikon dengan teks "Hapus" -->
                    </td>
                </tr>
            <?php $no++;
            endforeach; ?>
