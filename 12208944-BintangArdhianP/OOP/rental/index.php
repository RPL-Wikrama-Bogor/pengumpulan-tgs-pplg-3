...

{
     ...
     private $hargaAerox;
     private $hargaVario;
     private $listVIP = ['Bintang Ardhian Pratama', 'Kenzi Badrika', 'Munajat Fatur'];
     ...
     public function setHarga($Vesmet, $Aerox, $Vario)
     {
          $this->hargaVesmet = $Vesmet;
     ...
     {
          $semuaDataMotor["Vesmet"] = $this->hargaVesmet;
