                    ...
                    <div class="class-body">
                         ...
                         <div class="form-group mb-3">
                              ...
                              <select class="form-control" name="jenis_barang">
                                   <option value="Laptop" <?= ($data['barang']['jenis_barang'] == 'Laptop') ? 'selected' : '' ?>>
                                        Laptop</option>
                                   <option value="Handphone" <?= ($data['barang']['jenis_barang'] == 'Handphone') ? 'selected' : '' ?>>
                                        Handphone
                                   </option>
                                   <option value="AdaptorLAN" <?= ($data['barang']['jenis_barang'] == 'AdaptorLAN') ? 'selected' : '' ?>>
                                        AdaptorLAN
                                   </option>
                              </select>
                         </div>
