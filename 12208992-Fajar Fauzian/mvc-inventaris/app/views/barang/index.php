               ...
               <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex ">
                         <form action="<?= BASE_URL; ?>/barang/cari" method="post" class="d-flex" role="search">
                              <input class="form-control me-2" type="text" name="search" size="30" aria-label="Search"
                                   autofocus placeholder="search.." autocomplete="off">
                              <button class="btn btn-primary" type="submit" name="cari"><i
                                        class="ri-search-line"></i></button>
                              <a href="<?= BASE_URL ?>/barang/index/" class="btn btn-dark"><i
                    ...
                    <tbody>
                         ...
                         <tr>
                              ...
                              <td>
                                   ...
                                   <a href="<?= BASE_URL ?>/barang/edit/<?= $row['id'] ?>" class="btn btn-primary"><i
