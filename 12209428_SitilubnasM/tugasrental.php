...
$proces = new Rental();
$proces->setHarga(150000, 170000, 50000, 87000);
...
<?php 
    class Motor {
        ...
        private $hargaVario;
        private $listMember = ['lubna','egis', 'naura', 'hana'];
        ...
        public function setHarga($Aerox,$Beat,$Scooter,$Vario) {
            $this->hargaAerox = $Aerox;
            $this->hargaVespa = $Beat;
        ...
        public function getHarga(){
            ...
            $semuaDataMotor["Beat"] = $this->hargaVespa;
