...
const jwt = require('jsonwebtoken') //syntax ini untuk memanggil jwt
...
const register = (req, res) => {
    ...
    if (data.email == null || data.username == null || data.password == null) {
        ...
        const query3 = `SELECT * FROM users WHERE email='${data.email}' OR 
...
const login = ((req, res) => {
    ...
    if(email == null || password == null) {
        responseFailValidate(res, 'Email/Password sudah diisi')
    } else {
