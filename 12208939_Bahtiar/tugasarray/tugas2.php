...
if (isset($_POST["submit"])) {
    ...
    if ($_POST["makanan"] == ".." && $_POST["minuman"] == "..") {
        echo "
        <script>
        alert('isi yang bener gob..')
...
<body>
    <div class="container">
        <div class="kfc-logo">
            <img src="makan.png" alt="KFC Logo">
        </div>
            ...
            <ul>
                <li>
                    ...
                    <select name="mamam" id="mamam">
                        ...
                        <option value="<?php echo $makanan["3"] ?>">Soto ayam</option>
                        <option value="<?php echo $makanan["4"] ?>">Bakso</option>
                        <option value="<?php echo $makanan["5"] ?>">Mie Ayam</option>
                        <option value="<?php echo $makanan["6"] ?>">Gado-gado</option>
                    </select>
                </li>
                <li>
                    ...
                    <select name="minum" id="minum">
                        ...
                        <option value="<?php echo $minuman["6"] ?>">NurDin</option>
                    </select>
                </li>
            </ul>
            <ul>
                <li>
                    ...
                    <input type="text" name="makanan" value="" required >
                </li>
                <li>
                    <label for="minuman">How many packs  of Drinks:</label>
                    <input type="text" name="minuman" value="" required >
                </li>
            </ul>
