...
class modelBarang
{
    ...
    public function tambahbarang($data)
    {
        ...
        $query = "INSERT INTO tb_data (nama_peminjam, jenis_barang, no_barang, tgl_pinjam, tgl_kembali) VALUES(:nama_peminjam, :jenis_barang, :no_barang, :tgl_pinjam, :tgl_kembali)";
    ...
    public function updatebarang($data)
    {
        ...
        if ($tglKembaliBaru != $tglbalik) {
            ...
            $query = "UPDATE tb_data SET nama_peminjam=:nama_peminjam, jenis_barang=:jenis_barang, no_barang=:no_barang, tgl_pinjam=:tgl_pinjam, tgl_kembali=:tgl_kembali, status='Sudah Kembali' WHERE id=:id";
        } else {
            // Jika tanggal kembali baru sama dengan yang laxma
            $query = "UPDATE tb_data SET nama_peminjam=:nama_peminjam, jenis_barang=:jenis_barang, no_barang=:no_barang, tgl_pinjam=:tgl_pinjam, tgl_kembali=:tgl_kembali WHERE id=:id";
        }
