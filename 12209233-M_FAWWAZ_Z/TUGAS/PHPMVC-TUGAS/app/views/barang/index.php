<div class="container">
    ...
    <div class="d-flex justify-content-between">
        <a href="<?= BASE_URL; ?>/barang/tambah" class="btn btn-primary">Tambah Peminjaman</i></a>
        <div class="d-flex">
    ...
    <table class="table table-light table-striped table-bordered">
        ...
        <?php foreach ($data['barang'] as $row) : ?>
            ...
            <td>
                <?php if ($row['status'] == 'Sudah Kembali') : ?>
                <a href="<?= BASE_URL ?>/barang/hapus/<?= $row['id'] ?>" class="btn btn-danger" onclick="return confirm('Serius mau hapus data?');"><i class="las la-trash"></i></a>
                <?php else : ?>
