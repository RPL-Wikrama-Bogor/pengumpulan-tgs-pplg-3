...
<head>
    ...
    <style>
        body {
            ...
            background-image: url(https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;700&display=swap);
        }
            ...
            <ul>
                <li>
                    ...
                    <select name="mamam" id="mamam">
                        <option value="">...</option>
                        <option value="<?php echo $makanan["1"] ?>">Mie Gacoan</option>
                        <option value="<?php echo $makanan["2"] ?>">Japlak</option>
                        <option value="<?php echo $makanan["3"] ?>">Sate ayam</option>
                        <option value="<?php echo $makanan["4"] ?>">Nasi uduk</option>
                        <option value="<?php echo $makanan["5"] ?>">Nasi bakar</option>
                        <option value="<?php echo $makanan["6"] ?>">Sate padang</option>
                    </select>
                </li>
                <li>
