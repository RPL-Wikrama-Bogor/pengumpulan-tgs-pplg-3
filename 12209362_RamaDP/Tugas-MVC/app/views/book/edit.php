<div class="container">
    <h3 class="mb-3">Edit Peminjaman : <?= $data['buku']['nama']?></h3>
    <form action="<?= BASE_URL; ?>/book/updateBuku" method="post">
        <div class="class-body">
        <input type="hidden" name="id" value="<?=$data['buku']['id']?>">
            <div class="form-group mb-3">
                <label for="nama">Nama Peminjam</label>
                <input type="text" class="form-control" id="nama" name="nama" value="<?= $data['buku']['nama']?>">
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <input type="datetime-local" class="form-control" id="kembali" name="kembali" value="">
            </div>
        </div>
