...
if (isset($_POST["submit"])) {
    if ($_POST["judul"] == "kosong") {
        ...
        document.location.href= 'array2.php';
        </script>
        ";
    }
    $nama = $_POST["nama"];
    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <select name="judul" id="judul" required>
                ...
                <option value="Weathering With You">Weathering With You</option>
                <option value="Kimi No Nawa">Kimi No Nawa</option>
                <option value="Demon Slayer Mugen Train">Demon Slayer Mugen Train</option>
                <option value=" The Quintessential Quintuplets"> The Quintessential Quintuplets</option>
            </select>
