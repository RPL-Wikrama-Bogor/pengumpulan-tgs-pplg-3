...
<head>
    ...
    body {
        ...
        align-items: center;
        min-height: 100vh;
        background-image: url(https://wallpaperboat.com/wp-content/uploads/2019/11/cinema-01.jpg);
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <select name="judul_film" id="judul_film" required>
                <option value="the roundup: no way out">the roundup: no way out</option>
                <option value="Transformers: Rise of the beasts">Transformers: Rise of the beasts</option>
                <option value="Knights of the zodiac">Knights of the zodiac</option>
        ...
        <script>
            ...
            const texts = ["Halo Selamat Datang", "Pemesanan Tiket Bioskop"];
            let textIndex = 0;
        ...
        if (isset($_POST['submit'])) {
            ...
            $daftar_film = [
                "the roundup: no way out" => ["usia_minimum" => 17, "harga" => 30000],
                "Transformers: Rise of the beasts" => ["usia_minimum" => 13, "harga" => 32000],
                "Knights of the zodiac" => ["usia_minimum" => 15, "harga" => 35000],
