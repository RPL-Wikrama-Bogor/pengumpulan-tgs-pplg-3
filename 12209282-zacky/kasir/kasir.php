...
<body>
    ...
    <div class="menu-box">
        ...
        <div class="menu-table">
            <table>
                ...
                <tr>
                    <td>Mie yamin</td> <!-- Tambahkan Mie yamin -->
                    <td>Rp 20,000</td> <!-- Tambahkan Harga Mie yamin -->
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="menu-box">
        ...
        <div class="menu-table">
            <table>
                ...
                <tr>
                    <td>Jus Buah</td> <!-- Tambahkan Jus Buah -->
                    <td>Rp 8,000</td> <!-- Tambahkan Harga Jus Buah -->
                </tr>
            </table>
        </div>
    </div>
    ...
    <form action="" method="post">
        ...
        <div class="input-box">
            ...
            <select id="makanan1" name="menu_makanan1">
                ...
                <option value="Mie yamin">Mie yamin</option> <!-- Tambahkan Mie yamin -->
            </select>
            <br>
        ...
        <div class="input-box">
            ...
            <select id="minuman1" name="menu_minuman1">
                ...
                <option value="Jus Buah">Jus Buah</option> <!-- Tambahkan Jus Buah -->
            </select><br>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($jumlah_pesan_makanan > 0) {
            $hargaMakanan = ($menu_makanan == "mie ayam") ? 10000 : (($menu_makanan == "Mie ayam Bakso") ? 15000 : 20000); // Harga Mie yamin
        ...
        if ($jumlah_pesan_minuman > 0) {
            $hargaMinuman = ($menu_minuman == "Es Teh") ? 5000 : (($menu_minuman == "Es Jeruk") ? 7000 : 8000); // Harga Jus Buah
